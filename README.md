...
I'm an experienced Full Stack Software Developer in C#, .Net Framework, Ruby on Rails, Sinatra, JavaScript, Python, and React Redux. I am currently working in IT as a Desktop Support Technician. I have a background in healthcare, IT, strong interpersonal skills, and a knack for problem solving.
...
•	Flashcards App | [GitHub](https://github.com/vintran93/flashcard_app) | Built using React and Python - Users can create customized flashcards to aid in studying any topic of interest

•	Recipes App | [GitHub](https://github.com/vintran93/recipes_app) | Built using React and Python - Users can set up an account to post their favorite culinary recipes
...
•	Finances | Ruby on Rails [GitHub](https://github.com/vintran93/finances) | Python & React [GitHub](https://github.com/vintran93/finances_project) | [Video Demo](https://www.youtube.com/watch?v=ITwy3sj7G9U&t=370s) <br/>
Built using Ruby on Rails and bootstrap – a website built for users wanting to manage their finances by portfolios and to learn how to make investments. The Python and React Full stack version was also created for a more in-depth take on the application.
